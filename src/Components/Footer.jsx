        ...
        <>
            <div className="bg-gray-200 py-2">
                ...
                <div className="grid grid-cols-4">
                    ...
                    <div className="ml-2">
                        <p className="font-bold">TRENDING LOCATIONS</p>
                        <ul className="text-xs mt-2 text-gray-500">
                            <li>Bhubaneshwar</li>
                            <li>Hyderabad</li>
                            <li>Chandigarh</li>
                ...
                <div className="flex flex-col justify-between">
                    ...
                    <div className="flex">
                        ...
                        <img className="pl-4" src="/appstore.webp" alt="" />
                    </div>
                </div>
                </div>
            </div>
